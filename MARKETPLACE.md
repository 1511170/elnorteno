...
| `google-marketing-insights` | 0.1.0 | Conectores operativos para Google Search Console, GA4 y preparación de Google Ads usando Service Account/OAuth sin commitear secretos | google, search-console, analytics, ga4, ads, seo, reporting | google-service-account, search-console-access, ga4-property-access |
